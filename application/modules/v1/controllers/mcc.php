...
class mcc extends REST_Controller 
{
	public function __construct()
	{
		...
		$this->cdn_api->set(VERB_METHOD_ENDPOINT ,$this->get(VERB_METHOD_ENDPOINT));
	...
	public function user_get()
	{
		...
		$this->load->library( CORE_CLASS_MEDIA );
		$this->load->library( $node_endpoint );
		//because this is GET method, convert all args on url to be read for the library
		$this->$node_endpoint->set_resource(RESOURCE_VARNAME,$this->get());
		$this->$node_endpoint->init();
